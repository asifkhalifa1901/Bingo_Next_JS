...
function HomePage() {
    ...
    const [useFreeCenter, setUseFreeCenter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePage.useMemo[items]": ()=>rawItems.split("\n").map({
                "HomePage.useMemo[items]": (v)=>v.trim()
            }["HomePage.useMemo[items]"]).filter({
                "HomePage.useMemo[items]": (v)=>v.length > 0
            }["HomePage.useMemo[items]"])
    }["HomePage.useMemo[items]"], [
        rawItems
    ]);
    const grid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePage.useMemo[grid]": ()=>isClient ? generateBingoGrid(items, size, useFreeCenter) : []
    }["HomePage.useMemo[grid]"], [
        isClient,
        items,
        size,
        useFreeCenter,
...
_s(HomePage, "cMwFe9P1a1MQxLvBJKQmWFuqcpo=");
_c = HomePage;
var _c;
